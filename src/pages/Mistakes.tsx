...
import { ChevronLeft, Search, RefreshCcw, Trash2 } from 'lucide-react';
...
export function Mistakes() {
  ...
  useEffect(() => {
    ...
    setMistakeQuestions(mockMistakes);
  }, []);

  const handleClearAll = () => {
    // TODO: 清空 localStorage 中的错题记录
    setMistakeQuestions([]);
  };

  const handleStartPractice = () => {
    // TODO: 跳转到错题练习模式
    navigate('/exam?mode=mistakes');
  };
    ...
    <div className="min-h-screen bg-ios-gray-50">
      ...
      <div className="px-4 pt-12 pb-2 bg-white/90 backdrop-blur-ios sticky top-0 z-50 border-b border-ios-gray-100">
        <div className="flex items-center mb-4">
          ...
          <h1 className="text-2xl font-semibold text-ios-gray-900">错题本</h1>
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex space-x-4">
            <button
              ...
              className="flex items-center text-ios-gray-500"
            >
        ...
        {mistakeQuestions.map(question => (
          ...
          >
            <div className="flex items-start justify-between mb-3">
              ...
              <span className="text-ios-gray-500 text-sm">{question.lastMistakeTime}</span>
            </div>
            ...
            <div className="mt-3 flex items-center justify-between">
              <span className="text-ios-red text-sm">错误 {question.mistakeCount} 次</span>
              <button
        ...
        {mistakeQuestions.length === 0 && (
          <div className="flex flex-col items-center justify-center py-12">
            <div className="w-16 h-16 rounded-full bg-ios-gray-100 flex items-center justify-center mb-4">
              <RefreshCcw className="w-8 h-8 text-ios-gray-400" />
            </div>
            <p className="text-ios-gray-500">暂无错题记录</p>
          </div>
        )}
      </div>
    </div>
